    ...
    <Paper className={classes.root} style = { {backgroundColor: 'rgb(32, 135, 252)'} }>
      ...
      <Subtitulo titulo = 'Exámen respiratorio' />
        ...
        <Opcion titulo = 'Ruidos agregados' />
          <TextoMultiline error = {values.ruidos_agregados === '' ? true : false} name = 'ruidos_agregados' handleChange = {handleChange} value = {values.ruidos_agregados} label = 'Ruidos agregados'/>
        ...
        <Opcion titulo = 'Tos' />
          ...
          <TextoMultiline error = {values.tos !== 'no' && values.tos_descripcion === '' ? true : false} name = 'tos_descripcion' handleChange = {handleChange} value = {values.tos_descripcion} label = 'Descripción'/>
