    ...
    <Paper className={classes.root} style = { {backgroundColor: 'rgb(32, 135, 252)'} }>
      <Grid container spacing={3}>
        ...
        <Opcion titulo = 'Auscultación' />
          <TextoMultiline error = {values.auscultacion === '' ? true : false} name = 'auscultacion' handleChange = {handleChange} value = {values.auscultacion} label = 'Auscultación'/>
        ...
        <Opcion titulo = 'Soplos' />
          ...
          {values.soplos === 'si' &&
            <TextoMultiline error = {values.soplos === 'si' && values.soplos_descripcion === '' ? true : false} name = 'soplos_descripcion' handleChange = {handleChange} value = {values.soplos_descripcion} label = 'Descripción'/>
          }
        ...
        <Opcion titulo = 'Edemas Periféricos' />
          ...
          {values.edemas === 'si' &&
          <TextoMultiline error = { values.edemas_perifericos === '' ? true : false} name = 'edemas_perifericos' handleChange = {handleChange} value = {values.edemas_perifericos} label = 'Descripción de Edemas periféricos'/>
          }
