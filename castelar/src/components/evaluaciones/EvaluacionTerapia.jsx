...
const EvaluacionTerapia = ({terapias, setTerapias, paciente, nombreTerapia}) => {
  ...
  return (
    <Contenido titulo = {`Evaluación inicial ${nombreTerapia}`} handleChange = { handleChange } value = { values.evaluacion } name = 'evaluacion' label = 'Evaluación' minRows = {12} maxRows = {12} error = {values.evaluacion === "" ?true : false}/>
  )
}
