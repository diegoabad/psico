    ...
    <Grid container spacing={3}>
      ...
      <Subtitulo titulo = 'Orden judicial' />
        ...
        <Grid item xs = {12} sm = {8} md={2} style = {{margin: "10px"}}>
            <TextField className={classes.textField} fullWidth variant="filled"  label={"Curaduría/defensoría/juzgado"} required = { true } name="juzgado_nro" value={values.juzgado_nro} type="number" onChange={handleChange} error = {values.juzgado_nro === "" ? true : false}/>
        </Grid>
        <Grid item xs = {12} sm = {8} md = {2} style = {{margin: "10px"}}>
