...
const EvaluacionNutricional = ({ setOpenFiliatorio, registro}) => {
  ...
  const extraData = {
    ...
    else setNutricional({...nutricional, ...paciente[registro], fechaCreacion: paciente[registro].fechaCreacion.seconds? new Date(paciente[registro].fechaCreacion.seconds * 1000) : new Date(paciente[registro].fechaCreacion)});
	}, []);
