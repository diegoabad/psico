...
const Afectividad = ({setSemiologica, semiologica, paciente}) => {
  ...
  useEffect(() => {
    if (paciente) setValues({...values, 
      afectividad: paciente.afectividad,
      observacionAfectividad: paciente.observacionAfectividad})
  ...
  <Contenedor 
      ...
      texto = { false }
      multiline = {true}
      entrada={ { label: 'Observaciones', name: 'observacionAfectividad', value: values.observacionAfectividad, error: values.afectividad === 'otro' && values.observacionAfectividad === '' ? true : false} }
    >
