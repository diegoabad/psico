	...
	return (
		...
		>
			<Grid container spacing={3}>
				...
				<TextoMultiline
					error={values.infancia === '' ? true : false}
					label={'Infancia '}
					name='infancia'
					value={values.infancia}
					handleChange={handleChange}
				/>

				<Opcion titulo='Pubertad' />
				<TextoMultiline
					error={values.pubertad === '' ? true : false}
					label={'Pubertad '}
					name='pubertad'
					value={values.pubertad}
					handleChange={handleChange}
				/>

				<Opcion titulo='Adolescencia' />
				<TextoMultiline
					error={values.adolescencia === '' ? true : false}
					label={'Adolescencia '}
					name='adolescencia'
					value={values.adolescencia}
					handleChange={handleChange}
				/>

				<Opcion titulo='Juventud' />
				<TextoMultiline
					error={values.juventud === '' ? true : false}
					label={'Juventud '}
					name='juventud'
					value={values.juventud}
					handleChange={handleChange}
				/>

				<Opcion titulo='Adultez' />
				<TextoMultiline
					error={values.adultez === '' ? true : false}
					label={'Adultez '}
					name='adultez'
					value={values.adultez}
					handleChange={handleChange}
				/>
					...
					datos={[
						{
							...
							checked: values.estudios_primarios,
							label: 'Estudios primarios',
						},
						{
							name: 'estudios_secundarios',
							checked: values.estudios_secundarios,
							label: 'Estudios secundarios',
						},
						{
							name: 'estudios_terciarios',
							checked: values.estudios_terciarios,
							label: 'Estudios terciarios',
						},
						{
							name: 'estudios_universitarios',
				...
				<RadioButton
					...
					value={values.enfermedades_comunes}
				/>
				...
				{values.enfermedades_comunes === 'si' && (
					<TextoMultiline
						error={
							values.enfermedades_comunes === 'si' &&
							values.desc_enfermedades_comunes === ''
								? true
								: false
						}
						label={'Descripción '}
						name='desc_enfermedades_comunes'
						value={values.desc_enfermedades_comunes}
						handleChange={handleChange}
					/>
				)}
				...
				<RadioButton
					...
					titulo='Cirugías'
					name='cirugias_adultez'
					value={values.cirugias_adultez}
				/>
				...
				{values.cirugias_adultez === 'si' && (
					<TextoMultiline
						error={
							values.cirugias_adultez === 'si' &&
							values.desc_cirugias_adultez === ''
								? true
								: false
						}
						label={'Descripción '}
						name='desc_cirugias_adultez'
						value={values.desc_cirugias_adultez}
						handleChange={handleChange}
					/>
				)}
				...
				<RadioButton
					...
					titulo='Cirugías'
					name='otros_adultez'
					value={values.otros_adultez}
				/>

				{values.otros_adultez === 'si' && (
					<TextoMultiline
						error={
							values.otros_adultez === 'si' && values.desc_otros_adultez === ''
								? true
								: false
						}
						label={'Descripción '}
						name='desc_otros_adultez'
						value={values.desc_otros_adultez}
						handleChange={handleChange}
					/>
				)}
