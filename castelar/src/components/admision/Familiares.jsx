...
const Familiares = ({estado, setEstado, paciente}) => {
  ...
  useEffect(() => {
    if (paciente) {
      setValues({...values,
        situacion_actual: paciente.situacion_actual,
        padre: paciente.padre,
        edad_padre: paciente.edad_padre,
        madre: paciente.madre,
        edad_madre: paciente.edad_madre,
        hermano: paciente.hermano,
        edad_hermano: paciente.edad_hermano,
        hijo: paciente.hijo,
        edad_hijo: paciente.edad_hijo,
        familiares: paciente.familiares,
        edad_familiares: paciente.edad_familiares,
        antecedentes_psiquiatricos: paciente.antecedentes_psiquiatricos,
        detalle_antecedentes_psiquiatricos: paciente.detalle_antecedentes_psiquiatricos,
        antecedentes_adicciones: paciente.antecedentes_adicciones,
        detalle_antecedentes_adicciones: paciente.detalle_antecedentes_adicciones,
        antecedentes_enfermedades_somaticas: paciente.antecedentes_enfermedades_somaticas,
        detalle_antecedentes_enfermedades_somaticas: paciente.detalle_antecedentes_enfermedades_somaticas,
        habitos_alimentacion: paciente.habitos_alimentacion,
        detalle_habitos_alimentacion: paciente.detalle_habitos_alimentacion,
        experiencias: paciente.experiencias,
        detalle_experiencias: paciente.detalle_experiencias,
      })
    }
  },[])
