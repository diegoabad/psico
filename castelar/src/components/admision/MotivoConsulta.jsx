  ...
  <Paper className={classes.root} style = { {backgroundColor:'rgb(32, 135, 252)'} }>
    <Grid container spacing={3}>
      ...
      <Subtitulo titulo = 'Motivo Consulta' />
        ...
        <TextoMultiline name = 'motivo_consulta' handleChange = {handleChange} value = {values.motivo_consulta} label = 'Motivo consulta' error = {values.motivo_consulta === '' ? true : false}/>
