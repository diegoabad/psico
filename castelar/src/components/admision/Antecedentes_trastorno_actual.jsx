...
const Antecedentes_trastorno_actual = ({ estado, setEstado, paciente }) => {
	...
	useEffect(() => {
		if (paciente) {
			setValues({
				...
				internaciones_previas_descripcion:
					paciente.internaciones_previas_descripcion,
				...
				adherente_tratamiento_descripcion:
					paciente.adherente_tratamiento_descripcion,
	...
	const handleAutocomple = (event, value) => {
		const encontrado = values.psicofarmacos.find(
	...
	return (
		...
		>
			<Grid container spacing={3}>
				...
				<TextoMultiline
					error={values.antecedentes_trastorno_actual === '' ? true : false}
					label={'Antecedentes enfermedad o trastorno actual'}
					name='antecedentes_trastorno_actual'
					value={values.antecedentes_trastorno_actual}
					handleChange={handleChange}
				/>

				<Opcion titulo='Momento y circunstancias en qué aparecieron los síntomas' />
				<TextoMultiline
					error={values.aparicion_sintomas === '' ? true : false}
					label={'Circunstancia de aparición de síntomas'}
					name='aparicion_sintomas'
					value={values.aparicion_sintomas}
					handleChange={handleChange}
				/>

				<Opcion titulo='Relación con función (acontecimiento) vital' />
				<TextoMultiline
					error={values.relacion_funcion_vital === '' ? true : false}
					label={'Relación con función vital'}
					name='relacion_funcion_vital'
					value={values.relacion_funcion_vital}
					handleChange={handleChange}
				/>
				...
				{values.psico_previo === 'si' && (
					<>
						...
						<TextoMultiline
							error={values.antecedentes_psico === '' ? true : false}
							label={
								'Comienzo aproximado de la enfermedad o inicio del primer tratamiento'
							}
							name='antecedentes_psico'
							value={values.antecedentes_psico}
							handleChange={handleChange}
						/>
						...
						<RadioButton
							...
							handleChange={handleChange}
							datos={[
								{ name: 'psiquiatrico', label: 'Psiquiátrico' },
								{ name: 'psicologico', label: 'Psicológico' },
								{ name: 'combinado', label: 'Combinado' },
								{ name: 'desconoce', label: 'Desconoce' },
							]}
							titulo='Tratamiento'
						...
						<TextoMultiline
							...
							value={values.tratamiento_descripcion}
							handleChange={handleChange}
						/>
						...
						{values.internaciones_previas === 'si' && (
							<TextoMultiline
								error={
									values.internaciones_previas === 'si' &&
									values.internaciones_previas_descripcion === ''
										? true
										: false
								}
								label={'Descripción de internaciones previas'}
								name='internaciones_previas_descripcion'
								value={values.internaciones_previas_descripcion}
								handleChange={handleChange}
							/>
						)}
				...
				<RadioButton
					...
					titulo='Adherente al tratamiento'
				...
				<TextoMultiline
					error={
						...
						values.adherente_tratamiento_descripcion === ''
							? true
							: false
					}
					label={'Descripción'}
					name='adherente_tratamiento_descripcion'
					value={values.adherente_tratamiento_descripcion}
					handleChange={handleChange}
				/>
				...
				{values.intentos_suicidio === 'si' && (
					<TextoMultiline
						error={
							values.intentos_suicidio === 'si' &&
							values.modalidad_intento_suicidio === ''
								? true
								: false
						}
						label={'Modalidad'}
						name='modalidad_intento_suicidio'
						value={values.modalidad_intento_suicidio}
						handleChange={handleChange}
					/>
				)}
				...
				{values.autoagresividad === 'si' && (
					<TextoMultiline
						error={
							values.autoagresividad === 'si' &&
							values.detalle_autoagresividad === ''
								? true
								: false
						}
						label={'Modalidad'}
						name='detalle_autoagresividad'
						value={values.detalle_autoagresividad}
						handleChange={handleChange}
					/>
				)}
				...
				{values.heteroagresividad === 'si' && (
					<TextoMultiline
						error={
							values.heteroagresividad === 'si' &&
							values.detalle_heteroagresividad === ''
								? true
								: false
						}
						label={'Modalidad'}
						name='detalle_heteroagresividad'
						value={values.detalle_heteroagresividad}
						handleChange={handleChange}
					/>
				)}
				...
				{values.tabaquismo === 'si' && (
					<TextoMultiline
						error={
							values.tabaquismo === 'si' && values.detalle_tabaquismo === ''
								? true
								: false
						}
						label={'Tabaquismo'}
						name='detalle_tabaquismo'
						value={values.detalle_tabaquismo}
						handleChange={handleChange}
					/>
				)}
				...
				{values.alcoholismo === 'si' && (
					<TextoMultiline
						error={
							values.alcoholismo === 'si' && values.detalle_alcoholismo === ''
								? true
								: false
						}
						label={'Alcoholismo'}
						name='detalle_alcoholismo'
						value={values.detalle_alcoholismo}
						handleChange={handleChange}
					/>
				)}
				...
				{values.drogas === 'si' && (
					<TextoMultiline
						error={
							values.drogas === 'si' && values.detalle_drogas === ''
								? true
								: false
						}
						label={'drogas lícitas/ilícitas'}
						name='detalle_drogas'
						value={values.detalle_drogas}
						handleChange={handleChange}
					/>
				)}
				...
				{values.otros === 'si' && (
					<TextoMultiline
						error={
							values.otros === 'si' && values.detalle_otros === ''
								? true
								: false
						}
						label={'Detalle'}
						name='detalle_otros'
						value={values.detalle_otros}
						handleChange={handleChange}
					/>
				)}
			</Grid>
