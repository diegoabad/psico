  ...
  return (
    <Paper className={classes.root} style = { {backgroundColor:'rgb(32, 135, 252)'} }>
      <Grid container spacing={2}>
        ...
        <Subtitulo titulo = "Tratamiento sugerido" />
          ...
          <Card style= { { marginLeft: '10px', marginBottom: '10px' } }>
            <CardContent>
              ...
              <Radio handleChange = { handleChange } name = { 'duracion' } value = {values.duracion} titulo = 'Duración de la sesión' datos = {[{name:'30', label: '30 minutos'},{name: '45', label: '45 minutos'},{name: '60', label: '60 minutos'}]}/>
              <Divider style={{color: 'Black', marginTop: '10px', marginBottom: '10px'}}/>
        ...
        <Subtitulo titulo = "Tratamiento y Técnicas" />
          <Text handleChange = { handleChange } name = { 'pruebas' } value = {values.pruebas} titulo = 'Pruebas a administrar' error = {values.pruebas === '' ? true : false} minRows = {12} maxRows = {12}/>

        <Subtitulo titulo = "Rotulación" />
          <Text handleChange = { handleChange } name = {'rotulacion' } value = { values.rotulacion } label = {'Rotulación' } error = { values.rotulacion === '' ? true : false } minRows = { 4 } maxRows = { 4 }/>
