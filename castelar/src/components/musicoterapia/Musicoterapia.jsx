...
const Musicoterapia = ({terapias, setTerapias, paciente}) => {
  ...
  return (
    <Contenido titulo = 'Evolución' handleChange = { handleChange } value = { values.evolucion } name = 'evolucion' label = 'Evolución' minRows = {12} maxRows = {12} error = {values.evolucion === "" ? true : false }/>
  )
}
